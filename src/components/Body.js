...
const Body = ()=>{
    ...
    const fetchData=async()=>{
        const data = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=26.7509207&lng=94.2036696&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING")
